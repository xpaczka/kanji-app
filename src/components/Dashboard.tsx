...
export default async function Dashboard() {
  ...
  return (
    <div className="grid grid-cols-1 grid-rows-1 gap-6 lg:grid-cols-3 lg:gap-10">
      <div className="col-span-2">
        <LayoutSection header="Knowledge">
          <div className="grid grid-cols-1 grid-rows-4 gap-6 lg:grid-cols-2 lg:grid-rows-2 lg:gap-10">
            <DashboardCard
              header="Learn"
            ...
            <DashboardCard
              ...
              className="border-pink-600 bg-pink-500 text-white"
